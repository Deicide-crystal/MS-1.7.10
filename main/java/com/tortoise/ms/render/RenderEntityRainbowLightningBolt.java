package com.tortoise.ms.render;
...
public class RenderEntityRainbowLightningBolt extends Render {
    /*
     * 因为这个渲染器代码是从原版渲染器复制来的,我们只改了一个颜色 渲染参数还是原版雷电,但是彩雷没有继承原版雷电,无法转换所以报错
     * 我们在写渲染器的时候要记得把EntityLightningBolt改为你自己的彩雷实体
     */
    /**
     ...
     */
    public void doRender(EntityRainbowLightningBolt p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_,
        ...
        for (int k1 = 0; k1 < 4; ++k1) {
            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i1 = k; i1 >= l; --i1) {
                    ...
                    /* 原版透明度是0.3,这里改成0.5,可以看的更清楚,这一行代码是设置渲染颜色,我们只需要更改成随机颜色即可 */
                    tessellator.setColorRGBA_F(Color.nextFloat(), Color.nextFloat(), Color.nextFloat(), f2);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityRainbowLightningBolt p_110775_1_) {
        return null;
    }
    ...
    protected ResourceLocation getEntityTexture(Entity p_110775_1_) {
        return this.getEntityTexture((EntityRainbowLightningBolt) p_110775_1_);
    }
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_,
            float p_76986_9_) {
        this.doRender((EntityRainbowLightningBolt) p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_,
                p_76986_9_);
    }
}