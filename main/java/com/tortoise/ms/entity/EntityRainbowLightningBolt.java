package com.tortoise.ms.entity;
...
/* 继承天气效果,天气效果也继承于实体,并且原版雷电也是继承于实体的
复制原版雷电代码达到差不多的效果,因为只需要修改颜色
彩雷实体不需要注册。。。。
 */
public class EntityRainbowLightningBolt extends EntityWeatherEffect {
    /**
    ...
    public EntityRainbowLightningBolt(World p_i1703_1_, double p_i1703_2_, double p_i1703_4_, double p_i1703_6_) {
        super(p_i1703_1_);
            ...
            if (this.boltLivingTime == 0) {
                ...
                if (!this.worldObj.isRemote && this.worldObj.getGameRules().getGameRuleBooleanValue("doFireTick")
                    ...
                    if (this.worldObj.getBlock(i, j, k).getMaterial() == Material.air
                            && Blocks.fire.canPlaceBlockAt(this.worldObj, i, j, k)) {
