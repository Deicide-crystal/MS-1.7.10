...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage {
    ...
    public final PlayerUsageSnooper usageSnooper = new PlayerUsageSnooper("server", this, getSystemTimeMillis());
    ...
    public final ServerStatusResponse field_147147_p = new ServerStatusResponse();
    public final Random field_147146_q = new Random();
    ...
    protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long p_71247_3_, WorldType p_71247_5_,
        ...
        if (worldinfo == null) {
            worldsettings = new WorldSettings(p_71247_3_, this.getGameType(), this.canStructuresSpawn(),
                    this.isHardcore(), p_71247_5_);
    ...
    protected void initialWorldChunkLoad() {
        ...
        for (int k = -192; k <= 192 && this.isServerRunning(); k += 16) {
            for (int l = -192; l <= 192 && this.isServerRunning(); l += 16) {
                ...
                ++i;
                worldserver.theChunkProviderServer.loadChunk(chunkcoordinates.posX + k >> 4,
                        chunkcoordinates.posZ + l >> 4);
            }
        }
    ...
    public void stopServer() {
        if (!this.worldIsBeingDeleted && Loader.instance().hasReachedState(LoaderState.SERVER_STARTED)
                && !serverStopped) // make sure the save is valid and we don't save twice
        {
                ...
                while (this.serverRunning) {
                    ...
                    if (k > 2000L && i - this.timeOfLastWarning >= 15000L) {
                        logger.warn(
                                ...
                                new Object[] { Long.valueOf(k), Long.valueOf(k / 50L) });
                        k = 2000L;
    ...
    public void tick() {
        ...
        if (i - this.field_147142_T >= 5000000000L) {
            ...
            int j = MathHelper.getRandomIntegerInRange(this.field_147146_q, 0,
     ...
     * whether or not this game rule is set, so here's your answer"), warnings (like
     * "I fetched this block for you by ID, but I'd like you to know that every time
     * you do this, I die a little inside"), and errors (like "it's not called
     * iron_pixacke, silly").
     */
